...
\textbf{Shilin Zhu} did the implementation of gradient checking in Section 3.d and added the tricks in Section 4.

\textbf{Yunhui Guo} did the implementation of mini-batch gradient descent in Section 3(a,b,c,e) and experimented with network topology in Section 5.
