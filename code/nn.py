...
class Network():
    ...
    def __init__(self, layers, init_method_weights = random_init_weights, init_method_bias = random_init_bias, activation_fn = "sigmoid", learning_rate = 0.5, momentum = 1, epoches = 25, batch_size = 256):
        self.layers = layers
